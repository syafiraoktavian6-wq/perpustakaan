    ...
    <div class="w-full max-w-2xl my-10">
        ...
        <div class="bg-white/70 backdrop-blur-xl border border-white rounded-[2.5rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.06)] overflow-hidden">
            <div class="p-8 sm:p-12">
                ...
                <header class="text-center mb-10">
                    ...
                    <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight">Daftar Akun</h2>
                    <p class="text-slate-500 font-medium text-sm mt-1">Bergabung dengan ekosistem Perpus Digital</p>
                </header>
                ...
                <form action="/register" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-[10px] text-slate-400 font-bold ml-1 opacity-70">* Gunakan kombinasi huruf dan angka.</p>
                    </div>

                    <div class="space-y-2">
                        <label class="text-[11px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">Nama Lengkap</label>
                        <input type="text" name="NamaLengkap" placeholder="Nama sesuai identitas" required
                            class="w-full h-14 px-6 rounded-2xl bg-white border-2 border-slate-100 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 transition-all outline-none font-medium placeholder:text-slate-300">
                    </div>

                    <div class="space-y-2">
                        <label class="text-[11px] font-extrabold text-slate-400 uppercase tracking-widest ml-1">Alamat Lengkap</label>
                        <textarea name="Alamat" rows="3" placeholder="Jakarta" required
                            class="w-full p-6 rounded-[1.5rem] bg-white border-2 border-slate-100 focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 transition-all outline-none font-medium resize-none placeholder:text-slate-300"></textarea>
                    </div>
                    ...
                    <div class="pt-4">
                        <button type="submit" 
                            ...
                            Buat Akun Baru <i class="fas fa-arrow-right text-xs opacity-70"></i>
                        </button>
                    </div>
                </form>
        ...
        <footer class="text-center mt-12 mb-8">
            <p class="text-[11px] font-bold text-slate-300 uppercase tracking-[0.2em]">
                &copy; 2026 Perpus Digital &bull; SMK Negeri 11 Malang
            </p>
        </footer>
    </div>
</body>